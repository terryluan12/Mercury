...
enum cmd {LOGIN, LO_ACK, LO_NAK, EXIT, JOIN, JN_ACK, JN_NAK, ADDMIN, ADDMIN_ACK, ADDMIN_NAK,
		  LEAVE_SESS, NEW_SESS, REGISTER, KICK, KICK_ACK, KICK_NAK, NS_ACK, MESSAGE, QUERY, QU_ACK, USERKICK};
